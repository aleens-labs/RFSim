...
fs.writeFileSync(generatedTargetPath, payload, "utf8");

console.log(
  `Generated ${catalog.length} symbol entries -> ${path.relative(repoRoot, targetPath)}, ${path.relative(repoRoot, generatedTargetPath)}`,
);
